...
import TimeDataSource from "./TimeDataSource";

/**
 * The DataSource is the abstract class used to create different datasources.
 *
 */
class TimeSeriesDataSource extends TimeDataSource {
    /**
    ...
    constructor(name, properties) {
        ...
        assertDefined(properties.endTime,'endTime must must be defined');
    }
