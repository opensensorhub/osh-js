...
import SweApiFetchBinaryImageWorker from "./worker/SweApiFetchBinaryImage.worker";

class SweApiFetchImage extends SweApiFetch {
    ...
    async createWorker(properties) {
        ...
        if(properties.responseFormat === 'application/swe+binary') {
            return new SweApiFetchBinaryImageWorker();
        } else {
...
export default SweApiFetchImage;