...
import SosGetResultVideoWorker from "./worker/SosGetResultVideo.worker.js";
import SosGetResultJsonWorker from "./worker/SosGetResultJson.worker";
...
class SosGetResultVideo extends TimeSeriesDataSource {
    ...
    async createWorker(properties) {
        return new SosGetResultVideoWorker();
    }
}
