...
import SosGetResultJsonWorker from './worker/SosGetResultJson.worker.js';
import SosGetResultAudioWorker from "./worker/SosGetResultAudio.worker";
...
class SosGetResultJson extends TimeSeriesDataSource {
    ...
    async createWorker(properties) {
        return new SosGetResultJsonWorker();
    }
}
