...
import SosGetResultVideoWithRollWorker from './worker/SosGetResultVideoWithRoll.worker.js';
import SosGetResultVideoWorker from "./worker/SosGetResultVideo.worker";
...
class SosGetResultVideoWithRoll extends TimeSeriesDataSource {
    ...
    async createWorker(properties) {
        return new SosGetResultVideoWithRollWorker();
    }
}
