...
export const ExampleOpenLayers = (props) => {
 // Similar to componentDidMount and componentDidUpdate:
  useEffect(() => {
        ...
        const view = new OpenLayerView("ol-single-map",
        	[{
        		styler: pointMarker,
...
export const ExampleOpenLayersWithCustomBaseLayer = () => {
 // Similar to componentDidMount and componentDidUpdate:
  useEffect(() => {
        const dataSource = new SweJson("android-GPS", {
        	protocol: "ws",
        ...
        const view = new OpenLayerView("ol-single-baselayer-map",
        	[{
        		styler: pointMarker,
        		name: "Android Phone GPS"
        	}],
    ...
    return <div style={{height:500 +'px'}} id="ol-single-baselayer-map"></div>;
}

<ExampleOpenLayersWithCustomBaseLayer/>
