...
var SosGetFoisContext = /** @class */ (function (_super) {
    __extends(SosGetFoisContext, _super);
    function SosGetFoisContext() {
        return _super.call(this, new SosGetFoisParser()) || this;
    }
    /**
     * Builds the full url.
     * @protected
     ...
     */
    SosGetFoisContext.prototype.getQueryString = function (properties) {
        var queryString = _super.prototype.getQueryString.call(this, __assign({ responseFormat: 'application/xml' }, properties));
        // adds request
    ...
    SosGetFoisContext.prototype.parseData = function (messages) {
    ...
    SosGetFoisContext.prototype.connect = function () {
        var _this = this;
        if (isDefined(this.connector)) {
            this.connector.doRequest('', this.getQueryString(this.properties)).then(function (encodedData) { return __awaiter(_this, void 0, void 0, function () {
                var decodedData;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.parseData(encodedData)];
                        case 1:
                            decodedData = _a.sent();
...
//# sourceMappingURL=SosGetFois.context.js.map