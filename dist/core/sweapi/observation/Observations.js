...
var Observations = /** @class */ (function (_super) {
     ...
     */
    function Observations(networkProperties) {
        var _this = _super.call(this, networkProperties) || this;
        _this.sensorWebApiFetchObservation = new SensorWebApiFetchObservation(networkProperties);
        return _this;
    }
    /**
     ...
     */
    Observations.prototype.searchObservations = function (observationFilter, pageSize) {
        if (observationFilter === void 0) { observationFilter = new ObservationFilter(); }
        if (pageSize === void 0) { pageSize = 10; }
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, new Collection('/observations', observationFilter, pageSize, this.sensorWebApiFetchObservation, this._network.info.connector)];
            });
        });
    };
    return Observations;
