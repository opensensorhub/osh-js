...
var Systems = /** @class */ (function (_super) {
    __extends(Systems, _super);
    /**
     ...
     */
    Systems.prototype.searchSystems = function (systemFilter, pageSize) {
     ...
     */
    Systems.prototype.getSystemById = function (systemId, systemFilter) {
        if (systemFilter === void 0) { systemFilter = new SystemFilter(); }
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        apiUrl = API.systems.by_id.replace('{sysid}', systemId);
                        queryString = systemFilter.toQueryString(['select', 'format']);
                        return [4 /*yield*/, this.fetchAsJson(apiUrl, queryString)];
                    case 1:
                        jsonData = _a.sent();
                        return [2 /*return*/, this.sweApiFetchSystemParser.parseData(jsonData)];
                }
            });
        });
    };
