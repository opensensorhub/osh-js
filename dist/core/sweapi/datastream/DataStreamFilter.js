...
var DataStreamFilter = /** @class */ (function (_super) {
    ...
    function DataStreamFilter(properties) {
        return _super.call(this, __assign({ q: undefined, bbox: undefined, location: undefined, observedProperty: undefined, featureOfInterest: undefined, select: undefined, format: 'application/json', obsFormat: 'application/om+json', validTime: undefined, phenomenonTime: undefined, resultTime: undefined }, properties // merge defined properties
        )) || this;
        //TODO: assertions
    }
