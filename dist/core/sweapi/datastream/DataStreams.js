...
var DataStreams = /** @class */ (function (_super) {
    __extends(DataStreams, _super);
    /**
     ...
     */
    function DataStreams(networkProperties) {
     ...
     */
    DataStreams.prototype.searchDataStreams = function (dataStreamFilter, pageSize) {
        if (dataStreamFilter === void 0) { dataStreamFilter = new DataStreamFilter(); }
        if (pageSize === void 0) { pageSize = 10; }
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, new Collection(this.baseUrl() + API.datastreams.search, dataStreamFilter, pageSize, this.sweApiDataStreamParser)];
            });
        });
    };
    /**
     ...
     */
    DataStreams.prototype.getDataStreamById = function (datastreamId, dataStreamFilter) {
        if (dataStreamFilter === void 0) { dataStreamFilter = new DataStreamFilter(); }
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        apiUrl = API.datastreams.by_id.replace('{id}', datastreamId);
                        queryString = dataStreamFilter.toQueryString(['select', 'format']);
                        return [4 /*yield*/, this.fetchAsJson(apiUrl, queryString)];
                    case 1:
                        jsonData = _a.sent();
                        return [2 /*return*/, this.sweApiDataStreamParser.parseData(jsonData)];
                }
            });
        });
    };
