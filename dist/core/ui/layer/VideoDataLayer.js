 ...
 *
 */
var VideoDataLayer = /** @class */ (function (_super) {
    __extends(VideoDataLayer, _super);
    ...
    // call by super class
    VideoDataLayer.prototype.init = function (properties) {
        var _this = this;
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            ...
                            _b = ['roll'];
                            return [4 /*yield*/, this.getFunc('getRoll')(rec, timestamp, options)];
                        case 1:
...
//# sourceMappingURL=VideoDataLayer.js.map