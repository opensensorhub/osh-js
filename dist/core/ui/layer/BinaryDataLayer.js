 ...
 *
 */
var BinaryDataLayer = /** @class */ (function (_super) {
    __extends(BinaryDataLayer, _super);
    ...
    // call by super class
    BinaryDataLayer.prototype.init = function (properties) {
        var _this = this;
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            ...
                            _b = ['frameData'];
                            return [4 /*yield*/, this.getFunc('getFrameData')(rec, timestamp, options)];
                        case 1:
...
//# sourceMappingURL=BinaryDataLayer.js.map