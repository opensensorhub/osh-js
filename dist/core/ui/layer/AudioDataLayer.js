 ...
 *
 */
var AudioDataLayer = /** @class */ (function (_super) {
    __extends(AudioDataLayer, _super);
    function AudioDataLayer(properties) {
        var _this = _super.call(this, properties) || this;
        _this.type = 'audioData';
        return _this;
    }
    // call by super class
    AudioDataLayer.prototype.init = function (properties) {
        var _this = this;
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            ...
                            _b = ['sampleRate'];
                            return [4 /*yield*/, this.getFunc('getSampleRate')(rec, timestamp, options)];
                        case 1:
    ...
    return AudioDataLayer;
}(BinaryDataLayer));
export default AudioDataLayer;
//# sourceMappingURL=AudioDataLayer.js.map