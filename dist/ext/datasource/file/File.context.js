...
var FileContext = /** @class */ (function (_super) {
     ...
     */
    FileContext.prototype.getPaths = function (properties) {
        assertArray(properties.paths);
        return properties.paths;
    };
    FileContext.prototype.connect = function () {
        console.log('ici');
    ...
    FileContext.prototype.createDataConnector = function (properties) {
        return new FileConnector(this.getPaths(properties));
    };
    FileContext.prototype.parseData = function (message) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, Promise.resolve(this.parser.parseDataBlock(message))];
            });
        });
    };
    FileContext.prototype.onMessage = function (messages, format) {
        return __awaiter(this, void 0, void 0, function () {
            var _a;
