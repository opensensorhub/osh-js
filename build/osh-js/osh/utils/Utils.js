...
export var MAX_LONG = Math.pow(2, 53) + 1;
/**
 ...
 **/
export function assertDefined(v, letName) {
    if (letName === void 0) { letName = 'letiable'; }
    if (!isDefined(v)) {
        throw letName + " must be defined";
    }
    return v;
}
export function assertTrue(v, letName) {
    if (letName === void 0) { letName = 'letiable'; }
    if (!isDefined(v) || !v) {
        throw letName;
    }
 ...
 **/
export function assertType(v, expectedType, letName) {
    if (letName === void 0) { letName = 'letiable'; }
...
/**
 Assert that a letiable or object attribute is an object
 **/
export function assertArray(v, letName) {
    if (letName === void 0) { letName = 'letiable'; }
    assertDefined(v, letName);
    if (!Array.isArray(v)) {
...
/**
 Assert that a letiable or object attribute is defined and non-null
 **/
export function assertHasValue(v, letName) {
    if (letName === void 0) { letName = 'letiable'; }
    assertDefined(v, letName);
    if (!hasValue(v)) {
