...
module.exports = {
    ...
    entry: path.resolve(__dirname,'dji-video.js'),
    // Tell Weback to output our bundle to ./dist/bundle.js
    output: {
        filename: 'bundle.dji-video.js',
    ...
    plugins: [
        ...
        new HtmlWebpackPlugin({
            filename: 'dji-video.html',
            template: path.resolve(__dirname, 'dji-video.html')
        })
    ]
};
