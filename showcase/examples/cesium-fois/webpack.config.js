...
module.exports = {
    ...
    entry: path.resolve(__dirname,'cesium-fois.js'),
    // Tell Weback to output our bundle to ./dist/bundle.js
    output: {
        filename: 'bundle.cesium-fois.js',
    ...
    plugins: [
        ...
        new HtmlWebpackPlugin({
            filename: "cesium-fois.html",
            template: path.resolve(__dirname, 'cesium-fois.html')
        }),
