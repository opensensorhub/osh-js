...
module.exports = {
    ...
    entry: path.resolve(__dirname,'weather-marker.js'),
    // Tell Weback to output our bundle to ./dist/bundle.js
    output: {
        filename: 'bundle.weather.marker.js',
    ...
    plugins: [
        ...
        new HtmlWebpackPlugin({
            filename: "weather-marker.html",
            template: path.resolve(__dirname, 'weather-marker.html')
        }),
