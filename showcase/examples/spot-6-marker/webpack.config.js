...
module.exports = {
    ...
    entry: path.resolve(__dirname,'spot-6-marker.js'),
    // Tell Weback to output our bundle to ./dist/bundle.js
    output: {
        filename: 'bundle.spot.6.marker.js',
    ...
    plugins: [
        ...
        new HtmlWebpackPlugin({
            filename: "spot-6-marker.html",
            template: path.resolve(__dirname, 'spot-6-marker.html')
        }),
