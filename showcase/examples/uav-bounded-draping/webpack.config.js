...
module.exports = {
    ...
    entry: path.resolve(__dirname,'uav-bounded-draping.js'),
    // Tell Weback to output our bundle to ./dist/bundle.js
    output: {
        filename: 'bundle.uav.bounded.draping.js',
    ...
    devServer: {
        ...
        port: 9000,
        hot: true,
        index: 'uav-bounded-draping.html',
        https:true
    },
    devtool: 'source-map',
    plugins: [
        ...
        new HtmlWebpackPlugin({
            filename: "uav-bounded-draping.html",
            template: path.resolve(__dirname, 'uav-bounded-draping.html')
        }),
