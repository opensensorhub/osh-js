...
module.exports = {
    ...
    entry: path.resolve(__dirname,'cesium-frustum.js'),
    // Tell Weback to output our bundle to ./dist/bundle.js
    output: {
        filename: 'bundle.cesium.frustum.js',
    ...
    plugins: [
        ...
        new HtmlWebpackPlugin({
            filename: "cesium-frustum.html",
            template: path.resolve(__dirname, 'cesium-frustum.html')
        }),
