...
module.exports = {
    ...
    entry: path.resolve(__dirname,'predator-uav-location.js'),
    // Tell Weback to output our bundle to ./dist/bundle.js
    output: {
        filename: 'bundle.predator.uav.location.js',
    ...
    devServer: {
        ...
        port: 9000,
        hot: true,
        index: 'predator-uav-location.html',
        https:true
    },
    devtool: 'source-map',
    plugins: [
        ...
        new HtmlWebpackPlugin({
            filename: "predator-uav-location.html",
            template: path.resolve(__dirname, 'predator-uav-location.html')
        }),
