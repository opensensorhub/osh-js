function init() {
    ...
    var treeItems = [];
  //addWeather(entity ID, entity Name, offering ID, lat, lon, alt
    addWeather("simweather", "Sim Weather", "urn:mysos:offering03", 34.6459722, -86.7713056, 206);
    ...
    function addWeather(entityID, entityName, offeringID, lat, lon, alt) {
        console.log("Adding Weather Sensor", entityName);
        var weatherData = new OSH.DataReceiver.DataSourceSimWeather("Weather", {
            protocol : "ws",
            service: "SOS",
