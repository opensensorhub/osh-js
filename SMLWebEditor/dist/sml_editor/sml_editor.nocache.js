...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "sml_editor" because\n';
  ...
  $wnd.__gwt_activeModules['sml_editor'] = {
    'moduleName' : 'sml_editor',
    'bindings' : function() {
      return {};
    }
  };
 ...
 * "/sml_editor.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['sml_editor'].superdevmode = true;

  var expectedSuffix = '/sml_editor.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + sml_editor + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:sml_editor';
  var devModeSessionKey = '__gwtDevModeSession:sml_editor';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/sml_editor/sml_editor.nocache.js';
  ...
  $wnd.__gwt_activeModules['sml_editor'].canRedirect = true;
  $wnd.__gwt_activeModules['sml_editor'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/sml_editor?user.agent=' + ua + '&_callback=' + callback;
