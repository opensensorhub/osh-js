...
module.exports = {
    ...
    entry: path.resolve(__dirname,'remove-marker-by-id.js'),
    // Tell Weback to output our bundle to ./dist/bundle.js
    output: {
        filename: 'bundle.remove-marker-by-id.js',
    ...
    devServer: {
        ...
        port: 9000,
        hot: true,
        index: 'remove-marker-by-id.html'
    },
    devtool: 'source-map',
    plugins: [
        /**
        ...
        new HtmlWebpackPlugin({
            filename: "remove-marker-by-id.html",
            template: path.resolve(__dirname, 'remove-marker-by-id.html')
        }),
