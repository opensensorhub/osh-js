...
;// CONCATENATED MODULE: ../../../source/core/datasource/parsers/Video.parser.js


class VideoParser extends TimeSeriesParser_parser {
  /**
...
/* harmony default export */ var Video_parser = (VideoParser);
;// CONCATENATED MODULE: ../../../source/core/datasource/sos/parser/SosGetResultVideo.parser.js


class SosGetResultVideoParser extends Video_parser {
  /**
   * Builds the full url.
   * @protected
   * @param {Object} properties
...
/* harmony default export */ var SosGetResultVideo_parser = (SosGetResultVideoParser);
...
class MqttConnector extends protocol_DataConnector {
  ...
  disconnect() {
    ...
    if (Utils_isDefined(mqttProviders[this.getUrl()])) {
      // unsubscribe topic
      // find the client
...
class TimeSeriesDataSourceHandler extends handler_DataSourceHandler {
  ...
  async onMessage(event) {
    ...
    if (this.parser.lastStartTime === 'now' || Utils_isDefined(this.batchSize) && this.values.length >= this.batchSize) {
      this.flush();
...
;// CONCATENATED MODULE: ../../../source/core/datasource/sos/worker/SosGetResultVideo.worker.js
