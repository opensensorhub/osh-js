      ...
      if (this.client.connected) {
        try {
          ...
          for (let dataStreamId of dataStreamIds) {
            ...
            console.log(observationFilter.toQueryString()); // this.client.subscribe(dataStreamId+"?format=application/swe%2Bbinary", function (err) {c
...
class MqttConnector extends protocol_DataConnector {
  ...
  doRequest(topic = '', queryString = undefined) {
    ...
    mqttProvider.subscribeToObservations(topic, queryString, this.onMessage);
  }
