    ...
    return function e(t, r, n) {
      function i(s, a) {
        if (!r[s]) {
          if (!t[s]) {
            var l = undefined;
            if (!a && __webpack_require__(585)) return require(s, !0);
            if (o) return o(s, !0);
...
function hasValue(v) {
  return Utils_isDefined(v) && v !== null;
}
/**
...
function isArray(v) {
  return Utils_isDefined(v) && Array.isArray(v);
}
/**
...
function ReadData(struct, data, offsetBytes) {
  ...
  for (let i = 0; i < struct.fields.length; i++) {
    ...
    if (Utils_isDefined(currFieldStruct.type) && currFieldStruct.type !== null) {
      let ret = ParseBytes(data, offset, currFieldStruct.type);
      currFieldStruct.val = ret.val;
      offset += ret.bytes;
    } else if (Utils_isDefined(currFieldStruct.count) && currFieldStruct.count !== null) {
...
function GetResultObject(resultStructure) {
  ...
  for (let i = 0; i < resultStructure.fields.length; i++) {
    if (Utils_isDefined(resultStructure.fields[i].count)) {
...
function removeLastCharIfExist(value) {
  if (!Utils_isDefined(undefined) || value === null || value.length === 0 || !value.endsWith("/")) {
    return value;
  }
...
;// CONCATENATED MODULE: ../../../source/core/datasource/parsers/DataSourceParser.js
...
class DataSourceParser {
  ...
  buildUrl(properties) {
    ...
    if (Utils_isDefined(properties.customUrlParams) && Object.keys(properties.customUrlParams).length > 0) {
      url += '&';
...
/* harmony default export */ var parsers_DataSourceParser = (DataSourceParser);
;// CONCATENATED MODULE: ../../../source/core/datasource/parsers/TimeSeriesParser.parser.js



class TimeSeriesParserParser extends parsers_DataSourceParser {
  /**
   * Builds the full url.
   * @protected
   * @param {Object} properties
  ...
  buildUrl(properties) {
    ...
    const stTime = Utils_isDefined(properties.lastTimeStamp) ? properties.lastTimeStamp : properties.startTime;
...
/* harmony default export */ var TimeSeriesParser_parser = (TimeSeriesParserParser);
;// CONCATENATED MODULE: ../../../source/core/datasource/parsers/AbstractParser.js
...
class AbstractParser_AbstractParser {
  ...
  parseElement(element, path) {
    ...
    if (Utils_isDefined(path)) {
      this.path = path;
    }

    if (Utils_isDefined(this.path) && this.path in this.props.refs) {
...
;// CONCATENATED MODULE: ../../../source/core/datasource/parsers/common/DataChoiceParser.js


class AbstractDataChoiceParser extends AbstractParser_AbstractParser {
  build(element) {
...
/* harmony default export */ var common_DataChoiceParser = (AbstractDataChoiceParser);
;// CONCATENATED MODULE: ../../../source/core/datasource/parsers/common/RootParser.js


class RootParser extends AbstractParser_AbstractParser {
  build(element) {
...
;// CONCATENATED MODULE: ../../../source/core/datasource/parsers/GenericParser.js
...
;// CONCATENATED MODULE: ../../../source/core/datasource/parsers/TextDataParser.js




class StringParser extends AbstractParser_AbstractParser {
  parse(tokens, props, resultParent) {
...
class BooleanParser extends AbstractParser_AbstractParser {
  parse(tokens, props, resultParent) {
...
class TimeParser extends AbstractParser_AbstractParser {
  parse(tokens, props, resultParent) {
    resultParent[this.name] = tokens[props.index++];
  }
...
class CountParser extends AbstractParser_AbstractParser {
  build(element) {
    if ('value' in element) {
...
class DecimalParser extends AbstractParser_AbstractParser {
  parse(tokens, props, resultParent) {
    let val;
    let token = tokens[props.index++];
...
class DataChoiceParser extends common_DataChoiceParser {
  parse(tokens, props, resultParent) {
...
class TextDataParser extends parsers_GenericParser {
  ...
  parseDataBlock(input) {
    ...
    const blocks = dataBlock.split(this.resultEncoding.blockSeparator); //split 1 record
    ...
    function parseNode() {
      ...
      while (S.charCodeAt(pos) !== closeBracketCC && S[pos]) {
        ...
        if (c > 64 && c < 91 || c > 96 && c < 123) {
          ...
          if (!qname.startsWith('xmlns:')) node[name] = value;
        }
...
;// CONCATENATED MODULE: ../../../source/core/datasource/parsers/common/TraverseParser.js


class TraverseParser extends AbstractParser_AbstractParser {}

/* harmony default export */ var common_TraverseParser = (TraverseParser);
;// CONCATENATED MODULE: ../../../source/core/datasource/parsers/JsonDataParser.js
...
class JsonDataParser extends parsers_GenericParser {
  constructor(rootElement) {
    super(rootElement, {
      ...
      nodesIdValue: {},
      registeredParser: {
        'Time': () => new common_TraverseParser(),
...
;// CONCATENATED MODULE: ../../../source/core/datasource/parsers/common/SkipParser.js


class SkipParser extends AbstractParser_AbstractParser {
  build(element) {}
...
;// CONCATENATED MODULE: ../../../source/core/datasource/parsers/BinaryDataParser.js




class BinaryEncodingParser extends AbstractParser_AbstractParser {
  build(element) {
    // iterate over member
...
class MemberParser extends AbstractParser_AbstractParser {
  build(element) {
    this.parseElement(element);
  }
...
class DoubleParser extends AbstractParser_AbstractParser {
  constructor(name) {
    super();
    this.name = name;
  }
...
class IntParser extends AbstractParser_AbstractParser {
  constructor(name) {
    super();
    this.name = name;
  }
...
class ShortParser extends AbstractParser_AbstractParser {
  constructor(name) {
    super();
    this.name = name;
  }
...
class Float32Parser extends AbstractParser_AbstractParser {
  constructor(name) {
    super();
    this.name = name;
  }
...
class BinaryBlockParser extends AbstractParser_AbstractParser {
  ...
  parse(arrayBuffer, props, resultParent) {
    const block = {}; // everytime a binaryblock is defined in the binary encoding, there will be a 4-bytes length field before it
...
class ComponentParser extends AbstractParser_AbstractParser {
  build(element) {
...
class BlockParser extends AbstractParser_AbstractParser {
  build(element) {
    this.staticProp = {}; // check for static props
...
class BinaryDataParser_RootParser extends (/* unused pure expression or super */ null && (AbstractParser)) {
  build(element) {
    this.parseElement(element);
  }
...
class BinaryDataParser_TraverseParser extends AbstractParser_AbstractParser {}
  ...
  constructor(rootElement, encoding) {
    super(rootElement, {
      ...
      registeredParser: {
        ...
        'Time': () => new BinaryDataParser_TraverseParser(),
        'Category': () => new BinaryDataParser_TraverseParser(),
        'Quantity': () => new BinaryDataParser_TraverseParser(),
        'Count': () => new BinaryDataParser_TraverseParser(),
        'Boolean': () => new BinaryDataParser_TraverseParser(),
        'DataChoice': () => new BinaryDataParser_TraverseParser(),
...
;// CONCATENATED MODULE: ../../../source/core/datasource/sos/parser/SosGetResult.parser.js
...
class SosGetResultParser extends TimeSeriesParser_parser {
  constructor() {
    super();
  ...
  async checkInit() {
    if (!this.initialized) {
      if (!Utils_isDefined(this.templatePromise)) {
...
;// CONCATENATED MODULE: ../../../source/core/protocol/Status.js
/**
...
;// CONCATENATED MODULE: ../../../source/core/protocol/DataConnector.js
/***************************** BEGIN LICENSE BLOCK ***************************
...
/* harmony default export */ var protocol_DataConnector = (DataConnector);
;// CONCATENATED MODULE: ../../../source/core/protocol/WebSocketConnector.js
/***************************** BEGIN LICENSE BLOCK ***************************
...
class WebSocketConnector extends protocol_DataConnector {
  /**
   *
   * @param url -
   * @param {Object} properties -
  ...
  doRequest(extraUrl = '', queryString = undefined) {
    if (!this.init) {
      ...
      if (Utils_isDefined(queryString)) {
        fullUrl += '?' + queryString;
      }
...
/* harmony default export */ var protocol_WebSocketConnector = (WebSocketConnector);
;// CONCATENATED MODULE: ../../../source/core/protocol/TopicConnector.js
...
class TopicConnector extends protocol_DataConnector {
  /**
   *
   * @param properties -
   */
...
/* harmony default export */ var protocol_TopicConnector = (TopicConnector);
...
;// CONCATENATED MODULE: ../../../source/core/protocol/HttpConnector.js
/***************************** BEGIN LICENSE BLOCK ***************************
...
class HttpConnector extends protocol_DataConnector {
  /**
   * Creates Ajax.
   * @param {String} url -
   * @param {Object} properties -
...
/* harmony default export */ var protocol_HttpConnector = (HttpConnector);
// EXTERNAL MODULE: ../../../libs/mqtt/mqtt.min.js
var mqtt_min = __webpack_require__(647);
...
/* harmony default export */ var Filter = ((/* unused pure expression or super */ null && (Filter_SensorWebApiFilter)));
...
class ObservationFilter extends (/* unused pure expression or super */ null && (SensorWebApiFilter)) {
  /**
   *
...
/* harmony default export */ var observation_ObservationFilter = ((/* unused pure expression or super */ null && (ObservationFilter)));
...
class MqttProvider {
  ...
  constructor(properties) {
    ...
    if (!Utils_isDefined(properties.endpoint)) {
      throw Error('endpoint is a mandatory property');
    }

    if (!Utils_isDefined(properties.clientId)) {
      throw Error('clientId is a mandatory property');
    }

    this.mqttPrefix = '/api';

    if (Utils_isDefined(properties.mqttPrefix)) {
    ...
    if (Utils_isDefined(this.properties.options)) {
      options = { ...options,
  ...
  async subscribe(topic, callback) {
    if (!Utils_isDefined(this.client)) {
  ...
  isConnected() {
    return Utils_isDefined(this.client) && this.client.connected;
  }

}

/* harmony default export */ var mqtt_MqttProvider = (MqttProvider);
;// CONCATENATED MODULE: ../../../source/core/protocol/MqttConnector.js
/***************************** BEGIN LICENSE BLOCK ***************************
...
class MqttConnector extends protocol_DataConnector {
  /**
   *
   * @param properties -
   */
  ...
  async disconnect() {
    ...
    if (Utils_isDefined(client) && client.isConnected()) {
      // unsubscribe topic
    ...
    this.topics = []; //console.warn(`Disconnected from ${this.getUrl()}`);
  }
  ...
  isConnected() {
    return Utils_isDefined(mqttProviders[this.getUrl()]) && mqttProviders[this.getUrl()].isConnected();
  }
...
/* harmony default export */ var protocol_MqttConnector = (MqttConnector);
;// CONCATENATED MODULE: ../../../source/core/datasource/handler/DataSourceHandler.js
...
class DataSourceHandler {
  ...
  init(propertiesStr, topic, dataSourceId) {
    ...
    if (Utils_isDefined(this.parser)) {
  ...
  handleProperties(properties) {
    if (Utils_isDefined(properties.bufferingTime)) {
      this.bufferingTime = properties.bufferingTime;
    }

    if (Utils_isDefined(properties.timeOut)) {
      this.timeOut = properties.timeOut;
    }

    if (Utils_isDefined(properties.reconnectTimeout)) {
  ...
  setTopic(topic) {
    ...
    if (Utils_isDefined(this.broadcastChannel)) {
  ...
  async onMessage(event) {
    ...
    if (Array.isArray(data)) {
      for (let i = 0; i < data.length; i++) {
        ...
        if (Utils_isDefined(this.batchSize) && this.values.length >= this.batchSize) {
          this.flush();
        }
      }
    } else {
    ...
    if (!this.isConnected()) {
      this.flushAll();
    } else if (Utils_isDefined(this.batchSize) && this.values.length !== 0 && this.values.length >= this.batchSize) {
      this.flush();
    }
  }
  /**
...
/* harmony default export */ var handler_DataSourceHandler = (DataSourceHandler);
;// CONCATENATED MODULE: ../../../source/core/datasource/handler/TimeSeriesDataSourceHandler.js




class TimeSeriesDataSourceHandler extends handler_DataSourceHandler {
  constructor(parser) {
    super(parser);
    ...
    this.connector.onReconnect = () => {
      ...
      if (lastStartTimeCst !== 'now') {
        this.connector.setUrl(this.parser.buildUrl({ ...properties,
          lastTimeStamp: Utils_isDefined(this.lastTimeStamp) ? new Date(this.lastTimeStamp).toISOString() : properties.startTime
        }));
      }
  ...
  handleProperties(properties) {
    ...
    if (Utils_isDefined(properties.timeShift)) {
    ...
    if (properties.startTime === 'now') {
      ...
      if (Utils_isDefined(properties.replaySpeed)) {
        if (!Utils_isDefined(properties.batchSize)) {
          this.batchSize = 1;
        }
      }
  ...
  async onMessage(event) {
    ...
    if (this.lastStartTime === 'now' || Utils_isDefined(this.batchSize) && this.values.length >= this.batchSize) {
      this.flush();
  ...
  async updateProperties(properties) {
    try {
      ...
      if (Utils_isDefined(properties) && Utils_isDefined(properties.reconnect) && properties.reconnect) {
        this.connect();
      }
    } catch (ex) {
      console.error(ex);
...
/* harmony default export */ var handler_TimeSeriesDataSourceHandler = (TimeSeriesDataSourceHandler);
;// CONCATENATED MODULE: ../../../source/core/datasource/sos/worker/SosGetResult.worker.js



const dataSourceHandler = new handler_TimeSeriesDataSourceHandler(new SosGetResult_parser(), self);
