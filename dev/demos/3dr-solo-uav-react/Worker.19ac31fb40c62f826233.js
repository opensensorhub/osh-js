...
// CONCATENATED MODULE: /home/nevro/Progs/progs-local/git-repo/OSH/osh-js/source/core/datasource/parsers/AbstractParser.js
...
// CONCATENATED MODULE: /home/nevro/Progs/progs-local/git-repo/OSH/osh-js/source/core/datasource/parsers/common/DataChoiceParser.js


class DataChoiceParser_AbstractDataChoiceParser extends AbstractParser_AbstractParser {
  build(element) {
...
/* harmony default export */ var common_DataChoiceParser = (DataChoiceParser_AbstractDataChoiceParser);
// CONCATENATED MODULE: /home/nevro/Progs/progs-local/git-repo/OSH/osh-js/source/core/datasource/parsers/common/RootParser.js
...
// CONCATENATED MODULE: /home/nevro/Progs/progs-local/git-repo/OSH/osh-js/source/core/datasource/parsers/GenericParser.js
...
// CONCATENATED MODULE: /home/nevro/Progs/progs-local/git-repo/OSH/osh-js/source/core/datasource/parsers/TextDataParser.js




class TextDataParser_StringParser extends AbstractParser_AbstractParser {
  parse(tokens, props, resultParent) {
...
class TextDataParser_BooleanParser extends AbstractParser_AbstractParser {
  parse(tokens, props, resultParent) {
...
class TextDataParser_TimeParser extends AbstractParser_AbstractParser {
  parse(tokens, props, resultParent) {
    resultParent[this.name] = tokens[props.index++];
  }
...
class TextDataParser_CountParser extends AbstractParser_AbstractParser {
  build(element) {
    if ('value' in element) {
...
class TextDataParser_DecimalParser extends AbstractParser_AbstractParser {
  parse(tokens, props, resultParent) {
    let val;
    let token = tokens[props.index++];
...
class TextDataParser_DataChoiceParser extends common_DataChoiceParser {
  parse(tokens, props, resultParent) {
...
class TextDataParser_TextDataParser extends parsers_GenericParser {
  constructor(rootElement, encoding) {
    super(rootElement, {
      ...
      nodesIdValue: {},
      registeredParser: {
        'Time': () => new TextDataParser_TimeParser(),
        'Category': () => new TextDataParser_StringParser(),
        'Quantity': () => new TextDataParser_DecimalParser(),
        'Count': () => new TextDataParser_CountParser(),
        'Boolean': () => new TextDataParser_BooleanParser(),
        'DataChoice': () => new TextDataParser_DataChoiceParser()
      },
      refs: {}
    });
...
// CONCATENATED MODULE: /home/nevro/Progs/progs-local/git-repo/OSH/osh-js/source/core/datasource/parsers/common/TraverseParser.js
...
// CONCATENATED MODULE: /home/nevro/Progs/progs-local/git-repo/OSH/osh-js/source/core/datasource/parsers/JsonDataParser.js
...
// CONCATENATED MODULE: /home/nevro/Progs/progs-local/git-repo/OSH/osh-js/source/core/datasource/parsers/common/SkipParser.js
...
// CONCATENATED MODULE: /home/nevro/Progs/progs-local/git-repo/OSH/osh-js/source/core/datasource/parsers/BinaryDataParser.js




class BinaryDataParser_BinaryEncodingParser extends AbstractParser_AbstractParser {
  build(element) {
    // iterate over member
...
class BinaryDataParser_MemberParser extends AbstractParser_AbstractParser {
  build(element) {
    this.parseElement(element);
  }
...
class BinaryDataParser_DoubleParser extends AbstractParser_AbstractParser {
  constructor(name) {
    super();
    this.name = name;
  }
...
class BinaryDataParser_IntParser extends AbstractParser_AbstractParser {
  constructor(name) {
    super();
    this.name = name;
  }
...
class BinaryDataParser_ShortParser extends AbstractParser_AbstractParser {
  constructor(name) {
    super();
    this.name = name;
  }
...
class BinaryDataParser_Float32Parser extends AbstractParser_AbstractParser {
  constructor(name) {
    super();
    this.name = name;
  }
...
class BinaryDataParser_BinaryBlockParser extends AbstractParser_AbstractParser {
...
class BinaryDataParser_BlockParser extends AbstractParser_AbstractParser {
  build(element) {
    ...
    this.props.refs[element.ref] = new BinaryDataParser_BinaryBlockParser(this.name, this.staticProp);
  }

}

class BinaryDataParser_RootParser extends AbstractParser_AbstractParser {
  build(element) {
    this.parseElement(element);
  }
...
class BinaryDataParser_BinaryDataParser extends parsers_GenericParser {
  constructor(rootElement, encoding) {
    super(rootElement, {
      ...
      nodesIdValue: {},
      registeredParser: {
        'member': () => new BinaryDataParser_MemberParser(),
        'Component': () => new BinaryDataParser_ComponentParser(),
        'Block': () => new BinaryDataParser_BlockParser(),
        'BinaryEncoding': () => new BinaryDataParser_BinaryEncodingParser(),
...
// CONCATENATED MODULE: /home/nevro/Progs/progs-local/git-repo/OSH/osh-js/source/core/datasource/sos/parser/SosGetResult.parser.js
...
class DataSourceHandler_DataSourceHandler {
  ...
  async createDataConnector(properties, connector = undefined) {
    ...
    if (!isDefined(connector)) {
      ...
      if (properties.protocol.startsWith('ws')) {
        // for wss
        this.connector = new protocol_WebSocketConnector(url, properties);
  ...
  async onMessage(event) {
    let data = await this.parseData(event); // check if data is array
...
class TimeSeriesDataSourceHandler_TimeSeriesDataSourceHandler extends handler_DataSourceHandler {
  ...
  async createDataConnector(properties, connector) {
    await super.createDataConnector({ ...properties,
...
// CONCATENATED MODULE: /home/nevro/Progs/progs-local/git-repo/OSH/osh-js/source/core/datasource/sos/handler/SosDataSourceHandler.js
/***************************** BEGIN LICENSE BLOCK ***************************
...
class SosDataSourceHandler_SosDataSourceHandler extends handler_TimeSeriesDataSourceHandler {
  constructor(parser) {
    super();
    this.parser = parser;
  }
...
/* harmony default export */ var handler_SosDataSourceHandler = (SosDataSourceHandler_SosDataSourceHandler);
// CONCATENATED MODULE: /home/nevro/Progs/progs-local/git-repo/OSH/osh-js/source/core/datasource/sos/handler/SosGetResultDataSourceHandler.js
/***************************** BEGIN LICENSE BLOCK ***************************
...
class SosGetResultDataSourceHandler_SosGetResultDataSourceHandler extends handler_SosDataSourceHandler {
  constructor(parser) {
    super(parser);
  }
...
/* harmony default export */ var handler_SosGetResultDataSourceHandler = (SosGetResultDataSourceHandler_SosGetResultDataSourceHandler);
// CONCATENATED MODULE: /home/nevro/Progs/progs-local/git-repo/OSH/osh-js/source/core/datasource/sos/worker/SosGetResult.worker.js



const dataSourceHandler = new handler_SosGetResultDataSourceHandler(new SosGetResult_parser(), self);
