...
OSH.UI.PtzTaskingView = Class.create(OSH.UI.View, {
    initialize: function ($super, divId, options) {
        ...
        var increment = 5;
        $(this.rootTag).select("#button-tilt-up")[0].observe('click',  function(){this.onTiltClick(increment)}.bind(this));
        $(this.rootTag).select("#button-tilt-down")[0].observe('click',  function(){this.onTiltClick(-1*increment)}.bind(this));
        $(this.rootTag).select("#button-pan-right")[0].observe('click',  function(){this.onPanClick(increment)}.bind(this));
        $(this.rootTag).select("#button-pan-left")[0].observe('click',  function(){this.onPanClick(-1*increment)}.bind(this));
        $(this.rootTag).select("#button-zoom-in")[0].observe('click',  function(){this.onZoomClick(50)}.bind(this));
        $(this.rootTag).select("#button-zoom-out")[0].observe('click',  function(){this.onZoomClick(-50)}.bind(this));
    },
