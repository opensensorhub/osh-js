define(['dist/js/osh'], function() {
    ...
    describe('OSH.DataReceiver.VideoH264', function() {
        ...
        describe('parseData()', function() {
            it('parse and return video frame data from the data array buffer (offset by 12 bytes)', function() {
        ...
        describe('parseTimeStamp()', function() {
            it('parses and return timestamp from the data buffer converted to ms (i.e. x1000)', function() {
