...
module.exports = {
    ...
    entry: path.resolve(__dirname,'./datasources-synchronized-dynamic.js'),
    ...
    plugins: [
        ...
        new HtmlWebpackPlugin({
            filename: "datasources-synchronized-dynamic.html",
            template: path.resolve(__dirname, 'datasources-synchronized-dynamic.html')
        })
    ]
};
