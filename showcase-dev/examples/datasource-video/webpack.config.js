...
module.exports = {
    ...
    entry: path.resolve(__dirname,'./datasource-video.js'),
    // Tell Weback to output our bundle to ./dist/bundle.js
    output: {
        filename: 'bundle.datasource.video.js',
    ...
    plugins: [
        ...
        new HtmlWebpackPlugin({
            filename: "datasource-video.html",
            template: path.resolve(__dirname, 'datasource-video.html')
        })
    ]
};
